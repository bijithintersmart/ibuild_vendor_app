...
// import 'package:ibuild_vendor/core/utils/services/notification_service.dart';
...
bool navigateNewScreen(BuildContext context, String route,
    {Function(Object?)? onValue, dynamic extra}) {
...
String generateOrderCode(dynamic orderId) {
  const prefix = '#IB-';
  final idString = orderId.toString();
  final bytes = utf8.encode(idString);
  final digest = sha1.convert(bytes);
  final encoded = digest.toString().substring(0, 6).toUpperCase();
