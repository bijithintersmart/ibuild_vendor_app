...
import 'package:ibuild_vendor/features/network/domain/entities/enum.dart';
import 'package:ibuild_vendor/features/network/presentation/cubit/network_cubit.dart';
import 'package:ibuild_vendor/features/network/presentation/cubit/network_state.dart';
...
class ApiClient {
    ...
    _dio.interceptors.add(InterceptorsWrapper(
      ...
      onError: (DioException e, ErrorInterceptorHandler handler) async {
        ...
        if (_isNetworkError(e) &&
            _networkCubit.state.status == ConnectionStatus.offline) {
  ...
  void _navigateToTimeoutErrorScreen() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      GoRouter.of(navigatorKey.currentContext!).go(Routes.API_TIMEOUT_ERROR);
    });
  }
  ...
  Future<Response> get(
    ...
    try {
      if (_networkCubit.state.status == ConnectionStatus.offline) {
